...
ggsave(file.path(sfig_dir, paste0("Fig5_C_volcano_10pct_discovery_", DATE_STAMP, ".pdf")), p_c, width = 2.7, height = 2.8, units = "in", device = "pdf")
ggsave(file.path(sfig_dir, paste0("Fig5_D_volcano_15pct_discovery_", DATE_STAMP, ".pdf")), p_d, width = 2.7, height = 2.8, units = "in", device = "pdf")

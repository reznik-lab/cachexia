...
# ------------------ Fig3B / SFig3A-B: cachexia within first 180 days (stage 1-3, untreated at diagnosis) ------------------ #
# Fig3B (main) = consensus/WL5+modifier definition; SFig3 repeats this for WL10 and WL15

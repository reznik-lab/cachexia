...
# Fig4E: COADREAD Albumin (top) + ALK (bottom) trajectories over standardized
# time within episode, raw per-patient spaghetti lines (full vector, not
# rasterized) + GAM smooth by span. Needs RAW (non-z-scored) values, same raw
# labs merge as Fig4D/E.
# Adapted from 0303_ccx_revisions/rev_code/Figures/Fig4.R (Fig4F/G trajectories section).
...
# ------------------ COADREAD: Albumin + ALK combined trajectory ------------------

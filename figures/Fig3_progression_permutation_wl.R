...
# Parameterized version of Fig3_progression_permutation.R for the WL10/WL15
# SFig3 sensitivity panels (main Fig3 uses the consensus/WL5+modifier version,
# in Fig3_progression_permutation.R). Usage:
#   Rscript Fig3_progression_permutation_wl.R WL10
#   Rscript Fig3_progression_permutation_wl.R WL15

args <- commandArgs(trailingOnly = TRUE)
WL_LABEL <- args[1]
stopifnot(WL_LABEL %in% c("WL10", "WL15"))
...
cat("\nWrote", WL_LABEL, "permutation test outputs to:", out_dir, "\n")

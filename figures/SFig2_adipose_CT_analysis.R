...
# ------------------ load curated CT (VF/SQ) radiology data ------------------ #
...
# ------------------ corrected 0706 episodes (whole-cachexia-episode level) + regain (recovery) info ------------------ #
...
# ------------------ anchor dates -> day offsets (same convention for rad and eps) ------------------ #
...
# ------------------ match each CT scan pair to the nearest episode within +/-90 days ------------------ #
...
# ------------------ SAT / VAT: violin (baseline vs end/follow-up) + %-change histogram ------------------ #

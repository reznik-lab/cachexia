...
# SFig5: MSK discovery vs DFCI validation log2HR replication scatter.
# Adapted from 0303_ccx_revisions/rev_code/Figures/SFig5_genomics.R
# (SFig3-labeled section in the original, ~lines 195-333).
...
# label a handful of the most notable points per category: strongest "Both" hits
# (ranked by combined significance), plus a couple of representative
# discovery-only / validation-only points, matching how the manuscript figure
# highlights only the most notable pairs rather than every point.
...
ggsave(out_fp, p_scatter, width = 3.7, height = 4.0)

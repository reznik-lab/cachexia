...
# Parameterized version of Fig4BC_routine_labs_glmm.R for the SFig4D sensitivity
# variants (main Fig4B/C WL5-all-stages panel uses the dedicated script instead).
#   Rscript Fig4BC_routine_labs_glmm_param.R WL5_BMIlt20 "Stage 1-3"
#   Rscript Fig4BC_routine_labs_glmm_param.R WL5_BMIlt20 "Stage 4"
#   Rscript Fig4BC_routine_labs_glmm_param.R WL10 ALL
#   Rscript Fig4BC_routine_labs_glmm_param.R WL15 ALL
...
# computed from the full clinical cohort (not the stage/WL-filtered subset) -
# matches the original manuscript's approach (glmm_labs.R / SFig4.R both draw
# candidates from msk_clin directly, threshold 500)
...
# summary bar (mean log OR per test, disease-agnostic)

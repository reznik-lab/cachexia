...
# Rebuilds Fig4B (volcano: log2OR vs -log10FDR, per cancer-type x lab test) and
# Fig4C (tissue-agnostic mean log2OR summary bar) directly from the already-computed
# routine-labs GLMM results - no model refitting needed. Adapted from
# 0303_ccx_revisions/rev_code/Figures/Fig4.R (volcano + Fig4c sections), same
# colors/label-picking algorithm, only paths changed.
...
# ============================================================
# Fig4B: volcano (log2OR vs -log10FDR, per cancer-type x lab test)
# ============================================================
...
# ============================================================
# Fig4C: tissue-agnostic mean log2OR summary (with 95% CI error bars)
# ============================================================

...
# ------------------ WL10/WL15 exposure flags on top of cac_spans (from Fig2F_setup.R) ------------------ #
...
# ------------------ per-cancer Cox runner (WL10 + WL15 jointly modeled) ------------------ #
...
# fixed y-axis order (by exp_WL10 HR), shared with the WLGfirst forest plot so both panels
# show cancer types in the same top-to-bottom order for side-by-side comparison
